...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UtnNoticias.Acceso", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<Guid?>("PanelMonitoreoId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PanelMonitoreoId");

                    b.ToTable("Accesos");
                });

            modelBuilder.Entity("UtnNoticias.Alerta", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("listacontenedorId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("listacontenedorId");

                    b.ToTable("Alertas");
                });

            modelBuilder.Entity("UtnNoticias.Busqueda", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("UtnNoticias.ErrorAcceso", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ErrorAccesos");
                });

            modelBuilder.Entity("UtnNoticias.IComponente", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("IComponente");

                    b.HasDiscriminator<string>("Discriminator").HasValue("IComponente");
            ...
            modelBuilder.Entity("UtnNoticias.ListaContenedor", b =>
                {
                    b.HasBaseType("UtnNoticias.IComponente");

                    b.Property<string>("Nombre")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasDiscriminator().HasValue("ListaContenedor");
                });

            modelBuilder.Entity("UtnNoticias.Noticia", b =>
                {
                    b.HasBaseType("UtnNoticias.IComponente");
                    ...
                    b.HasDiscriminator().HasValue("Noticia");
                });

            modelBuilder.Entity("UtnNoticias.Acceso", b =>
                {
                    b.HasOne("UtnNoticias.ErrorAcceso", "Error")
                        .WithMany()
                        .HasForeignKey("ErrorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UtnNoticias.PanelMonitoreo", null)
                        .WithMany("Accesos")
                        .HasForeignKey("PanelMonitoreoId");
            ...
            modelBuilder.Entity("UtnNoticias.Alerta", b =>
                {
                    b.HasOne("UtnNoticias.Busqueda", "busqueda")
                        .WithMany()
                        .HasForeignKey("busquedaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UtnNoticias.ListaContenedor", "listacontenedor")
                        .WithMany()
                    ...
                    b.Navigation("listacontenedor");
                });

            modelBuilder.Entity("UtnNoticias.IComponente", b =>
                {
                    b.HasOne("UtnNoticias.ListaContenedor", null)
            ...
            modelBuilder.Entity("UtnNoticias.Themes.Theme", b =>
                {
                    b.HasOne("UtnNoticias.Themes.Theme", null)
                        .WithMany("Themes")
